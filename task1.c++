...
int main()
{
    ...
    cout << "Number " << nums[1] << " Award Is: " << awards[0] << endl;
...
// in DART void main()
// {
//     List<int> nums = [ 100, 300, 600, 900 ];
//     List<String> awards = [ "iPhone", "iPad", "PC", "Car" ];
//     print("Number ${nums[1]} Award Is: ${awards[0]}");
//     print("Number ${nums[1]} Award Is: ${awards[1]}");
//     print("Number ${nums[2]} Award Is: ${awards[2]}");
//     print("Number ${nums[3]} Award Is: ${awards[3]}");
// }
